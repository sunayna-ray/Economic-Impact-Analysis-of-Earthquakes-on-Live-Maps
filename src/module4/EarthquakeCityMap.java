...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		textSize(12);
		fill(30);
		String s="City Marker\n\nLand Quake\n\nOcean Quake\n\n";
		text(s,115, 140);
		fill(255, 0, 255);
		triangle(85, 135, 79, 144, 91, 144);
		fill(255);
		ellipse(85, 175, 10, 10);
		rect(80, 205, 10, 10);
		textSize(16);
		text("Size~Magnitude", 220, 90);
		...
		fill(0, 0, 0);
		text("Shallow", 115, 225);
		text("Intermediate", 115, 245);
		text("Deep", 115, 265);
	...
	private void printQuakes() 
	{
		...
		for(Marker cm : countryMarkers){
			int qcount=0;
			String cc=(String)cm.getProperty("name");
			for(Marker qm: quakeMarkers){
				if(((EarthquakeMarker)qm).isOnLand()){
					String qc=(String)qm.getProperty("country");
					if(qc.equals(cc))
						qcount++;
				}
			}
			System.out.println(cc+": "+qcount);
			tcount-=qcount;
		}
		System.out.println("OCEAN QUAKES: "+tcount);
		//        
